...
LIST_PAGE_URL = f"{BASE_URL}/indeks?page="
MAX_LIMIT = 5 # Set the total number of articles you want to process
...
def scrape_full_article(article_url):
    ...
    SOURCE_CATEGORY_SELECTOR = 'div.page__breadcrumb a' 
    DATE_SELECTOR = 'div.detail__date' 
    ARTICLE_SELECTOR = 'div.detail__body-text' # Selector for the main article body
    ...
    try:
        ...
        date_source_container = soup.select_one(DATE_SELECTOR)
        ...
        if date_source_container:
            ...
            if len(parts) >= 2:
                ...
                full_date = parts[1].strip() # Hasil: "Kompas.com"
